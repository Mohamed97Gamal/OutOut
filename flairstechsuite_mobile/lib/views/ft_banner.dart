...
const double _kOffset = 44.0; // distance to bottom of banner, at a 45 degree angle inwards
...
class FTBanner extends StatelessWidget {
  /// Creates a banner.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(
      foregroundPainter: FTBannerPainter(
        message: message,
...
class FTBannerPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(FTBannerPainter oldDelegate) {
