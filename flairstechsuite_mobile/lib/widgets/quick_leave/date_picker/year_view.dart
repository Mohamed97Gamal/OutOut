...
abstract class _IYearViewRenderObject extends RenderBox
  ...
  Decoration? _updateCellDecoration(int j, bool isCurrentDate, bool isEnableDate,
      bool isActiveDate, bool isDisabledDate) {
    if (!isEnableDate || isDisabledDate) {
...
void _drawYearCells(
  ...
  if (isNeedWidgetPaint) {
    ...
    for (int j = 0; j < count; j++) {
      ...
      /// Calcu the selected index values based on selected date property.
