...
class DateRangePickerHeaderStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late DateRangePickerHeaderStyle otherStyle;
...
class DateRangePickerViewHeaderStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late DateRangePickerViewHeaderStyle otherStyle;
...
class DateRangePickerWeekNumberStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late DateRangePickerWeekNumberStyle otherStyle;
...
class DateRangePickerMonthViewSettings with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late DateRangePickerMonthViewSettings otherStyle;
    ...
    return otherStyle.dayFormat == dayFormat &&
        ...
        otherStyle.specialDates2 == specialDates2 &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableDiagnostics<DateTime>(specialDates2)
        .toDiagnosticsNode(name: 'specialDates2'));
...
class DateRangePickerYearCellStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late DateRangePickerYearCellStyle otherStyle;
...
class DateRangePickerMonthCellStyle with Diagnosticable {
  ...
  const DateRangePickerMonthCellStyle(
      ...
      this.specialDates2TextStyle,
      this.specialDatesDecoration,
      this.specialDates2Decoration,
  ...
  final TextStyle? specialDates2TextStyle;
  ...
  final Decoration? specialDates2Decoration;
  ...
  bool operator ==(dynamic other) {
    ...
    late DateRangePickerMonthCellStyle otherStyle;
    ...
    return otherStyle.textStyle == textStyle &&
        ...
        otherStyle.specialDates2TextStyle == specialDates2TextStyle &&
        otherStyle.specialDatesDecoration == specialDatesDecoration &&
        otherStyle.specialDates2Decoration == specialDates2Decoration &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>(
        'specialDates2TextStyle', specialDates2TextStyle));
    properties.add(DiagnosticsProperty<TextStyle>(
        'disabledDatesTextStyle', disabledDatesTextStyle));
    properties.add(DiagnosticsProperty<Decoration>(
        'disabledDatesDecoration', disabledDatesDecoration));
    ...
    properties.add(DiagnosticsProperty<Decoration>(
        'specialDates2Decoration', specialDates2Decoration));
  }
