...
import 'package:flairstechsuite_mobile/widgets/quick_leave/date_picker/hijri_date_picker_manager.dart';
import 'package:flairstechsuite_mobile/widgets/quick_leave/date_picker/picker_helper.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
...
class _SfDateRangePicker extends StatefulWidget {
  ...
  final dynamic extendableRangeSelectionDirection;
...
class _SfDateRangePickerState extends State<_SfDateRangePicker>
  ...
  ValueNotifier<List<dynamic>?>? _viewHeaderVisibleDates;
  ...
  /// Handle the control size changed red view updates on scroll navigation
  /// mode.
  ...
  void _handleScrollChanged() {
    ...
    if (widget.enableMultiView) {
     if(widgetSize!=null) widgetSize /= 2;
    }
  ...
  /// Calcu and add the visible date collection for scroll view based on
  /// [isNextView] value.
        ...
        case DateRangePickerView.century:
          {
            ...
            // ignore: always_specify_types
            final visibleDates = DateRangePickerHelper.getVisibleYearDates(
              visibleDate,
              currentView,
              widget.isHijri,
            );
  ...
  Widget _addScrollView(
    ...
    _pickerScrollController ??= ScrollController()
      ..addListener(_handleScrollChanged);
    final currentView = DateRangePickerHelper.getPickerView(_view);
    final int? numberOfWeeksInView =
        DateRangePickerHelper.getNumberOfWeeksInView(
            widget.monthViewSettings, widget.isHijri);
      ...
      Positioned(
        ...
        child: _AnimatedOpacityWidget(
          ...
          child: _PickerScrollView(
            ...
            _locale,
            _textScaleFactor,
            getPickerStateValues: (details) {
              _getPickerStateValues(details);
            },
            updatePickerStateValues: (details) {
...
class _StickyHeaderRenderObject extends RenderStack {
  ...
  void updateHeaderOffset() {
    ...
    /// Calcu the current view offset by view position on scroll view,
    ...
    /// Calcu the offset value for horizontal direction with rtl by
    /// using content size and header size
    /// Eg., If initially header in position 0 then calcu the offset on RTL
...
class _PickerScrollViewState extends State<_PickerScrollView>
  ...
  // ignore: use__for_private_fields_and_variables
  ...
  void _updateVisibleDates() {
    ...
    final view = DateRangePickerHelper.getPickerView(widget.controller.view);
  ...
  _PickerView _getView(List<dynamic>? dates, Key? key) {
    return _PickerView(
      ...
      DateRangePickerHelper.cloneList((_disabledDates != null &&
          ...
          : null),
      key: key,
      getPickerStateDetails: (details) {
        _getPickerViewStateDetails(details!);
      },
      updatePickerStateDetails: (details) {
  ...
  List<Widget> _addViews(BuildContext context) {
    if (_children.isEmpty) {
      ...
      return _children?.cast<Widget>()??[].cast<Widget>();
    }
  ...
  void _updateSettings(_PickerScrollView oldWidget) {
    ...
    if (oldWidget.picker.monthViewSettings != widget.picker.monthViewSettings ||
        ...
        oldWidget.picker.monthViewSettings.specialDates2 !=
            widget.picker.monthViewSettings.specialDates2 ||
  ...
  /// Calcu and return the date time value based on previous selected date,
  ...
  dynamic _getYearSelectedDate(dynamic selectedDate, LogicalKeyboardKey key,
    ...
    /// Calcu the index value for previous selected date.
    ...
    if (key == LogicalKeyboardKey.arrowRight) {
      ...
      /// navigate to next view. Calcu the selected index on navigated view
      ...
      /// navigate to previous view. Calcu the selected index on navigated
      ...
      /// If index value not in first row then calcu the date by
      ...
      /// If index value not in last row then calcu the date by
    ...
    if (widget.enableMultiView) {
      switch (widget.picker.navigationDirection) {
        case DateRangePickerNavigationDirection.horizontal:
          {
            columnCount *= 2;
            if(width!=null)  width -= widget.picker.viewSpacing;
            if(width!=null) if (xPosition > width / 2 &&
    ...
    if (widget.enableMultiView) {
      switch (widget.picker.navigationDirection) {
        ...
        case DateRangePickerNavigationDirection.vertical:
          {
            height = (height - widget.picker.viewSpacing) / 2;
            if(totalRowCount!=null) totalRowCount *= 2;
            if (yPosition > height &&
                yPosition < height + widget.picker.viewSpacing) {
              return index;
            } else if (yPosition > height) {
