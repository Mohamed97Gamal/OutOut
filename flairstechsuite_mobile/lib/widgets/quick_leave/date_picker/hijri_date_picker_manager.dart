...
class HijriDatePickerMonthViewSettings with Diagnosticable {
  ...
  final List<HijriDateTime>? specialDates2;
  ...
  bool operator ==(dynamic other) {
    ...
    late HijriDatePickerMonthViewSettings otherStyle;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableDiagnostics<HijriDateTime>(specialDates2)
...
class HijriDatePickerYearCellStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late HijriDatePickerYearCellStyle otherStyle;
...
class HijriDatePickerMonthCellStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late HijriDatePickerMonthCellStyle otherStyle;
