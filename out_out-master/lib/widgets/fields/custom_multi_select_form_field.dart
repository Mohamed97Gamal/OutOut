...
class CustomMultiSelectFormField<T> extends StatefulWidget {
  ...
  const CustomMultiSelectFormField({
    ...
    this.checkBoxActiveColor = OutOutApp.primaryColor,
    this.enabled = true,
    this.onItemPressed,
  ...
  @override
  _CustomMultiSelectFormFieldState<T> createState() => _CustomMultiSelectFormFieldState<T>();
}

class _CustomMultiSelectFormFieldState<T> extends State<CustomMultiSelectFormField<T>> {
  @override
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              UniversalImage(IconAssets.close, width: 10.0, height: 10.0),
