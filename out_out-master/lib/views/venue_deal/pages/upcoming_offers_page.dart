...
class UpComingOffersPage extends TabViewItem {
  const UpComingOffersPage({Key? key})
      : super(title: "Upcoming Offers", key: key);
      ...
      child: CustomPagedListView<OfferWithVenueResponse>(
        ...
        initPageFuture: (pageKey) async {
          ...
          var dealsResult = await ApiRepo()
              .offerClient
              .getActiveNonExpiredUpcomingOffers(request, pageKey, 7);
